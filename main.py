...
# TODO 4) предусмотреть тайминг для парсинга вакансии после прохождения 250 ходов. # noqa
# TODO 5) проработать старт для куки
# TODO компанию работодателя добавить бы в базу данных?
# TODO 1) сделать список своих навыков и требований
...
# TODO предусмотреть функцию для очистки БД
